...
@Component({
  selector: 'app-offercharitymembership',
  templateUrl: './offercharitymembership.component.html',
  styleUrls: ['./offercharitymembership.component.css']
})
export class OffercharitymembershipComponent implements OnInit {
